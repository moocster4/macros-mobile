...
export default function PlanForm({ onSaved, saveLabel = "Save plan" }: { onSaved: () => void; saveLabel?: string }) {
  ...
  if (loading) {
    return <View style={styles.center}><ActivityIndicator color={ORANGE} /></View>;
  }
